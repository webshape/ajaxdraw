...
\begin{figure}[!ht]
\centering
\includegraphics{images/absfactory.jpg}
...
\begin{figure}[!ht]
\centering
\includegraphics{images/GUIlogic.jpg}
\caption{GUILogic}
\end{figure}
...
\begin{figure}[!ht]
\centering
\includegraphics{images/bozzaGUI.jpg}
...
\begin{figure}[!ht]
\centering
\includegraphics{images/applogic.jpg}
...
\begin{figure}[!ht]
\centering
\includegraphics{images/gestionefigure.jpg}
...
\subsezione{Button}
\subsubsezione{Tipo, obiettivo e funzione del componente}
Classe concreta che rappresenta un generico pulsante tramite il quale effettuare l'operazione desiderata, che pu\`o  essere una funzione di disegno oppure di salvataggio o caricamento di un'immagine.
\subsubsezione{Relazioni d'uso di altre componenti}
