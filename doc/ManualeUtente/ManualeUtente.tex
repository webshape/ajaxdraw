...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.4]{images/cancella_prima.png}
\caption{Cancellazione di un elemento di disegno  - PRIMA}
\end{figure} 

\begin{figure}[!ht]
\centering
\includegraphics[scale=0.4]{images/cancella_dopo.png}
=======
%\begin{figure}[!ht]
%\centering
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.4]{images/cambio_#lati_prima.png}
\caption{cambio numero lati di un poligono  - PRIMA}
\end{figure} 

\begin{figure}[!ht]
\centering
\includegraphics[scale=0.4]{images/cambio_#lati_dopo.png}
