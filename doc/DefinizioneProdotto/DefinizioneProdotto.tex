...
\begin{elencopuntato}[\subsubsecindent]
\item[-] \textit{getId()} ritorna  \textit{{\_}id};
\item[-]  \textit{bindCanvas(toolbar,canvas,canvasObj,visual,figureSet,eraseButton)} overriding del metodo ereditato da \textit{Button}, collega il canvas all'azione di selezione di una figura disegnata sul canvas e a tutte le operazioni disponibili su di essa.
\end{elencopuntato}
