...
\paragrafo{Metodi pubblici:}
\begin{elencopuntato}[\normindent]
\item[-] \textit{sweeper()} controlla tramite una classe filtro se esistono dei file sul server inutilizzati da un determinato periodo e tramite la classe \textit{File} li rimuove.
\end{elencopuntato}[\normindent]
