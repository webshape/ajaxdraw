...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.65]{button.jpg}
\caption{Classi e loro relazioni - Bottoni e toolbar}
\end{figure}
...
Gestisce completamente le figure: il disegno, la conversione da e verso \underline{SVG}, le loro propriet\`a, la loro manipolazione e creazione. Utilizza le interfacce messe a disposizione dallo strato server e offre le proprie funzionalit\`a allo strato GUI. Nel grafico in figura 2 si riportano le classi per la gestione delle figure con le loro relazioni. Nel diagramma non si mostrano attributi e metodi in quanto ampiamente descritti testualmente in seguito.
