...
\begin{itemize}
\item Il costo totale stimato \`e di 13790 euro. Eventuali costi aggiuntivi non saranno a carico del committente ma saranno coperti dall'azienda.
\item Sono previste 667 ore di lavoro totali per la realizzazione del progetto.
...
\begin{table}[h]
	\begin{center}
		 ...
		 \hline
		RResponsabile & 71 & 2130 \\
		Amministratore & 97 & 1940\\
		Analista & 98 & 2450\\
		Progettista & 144 & 3168\\
		Programmatore & 96 & 1536 \\
		Verificatore & 161 & 2576\\
        \hline
        \textbf{Totale} & \textbf{667} & \textbf{13790}\\
		\hline
		\end{tabular}
...
\begin{table}[h]
	\begin{center}
		 ...
		 \hline
		Responsabile & 13 & 380 \\
		Amministratore & 28 & 400\\
		Analista & 0 & 0\\
		Progettista & 0 & 0\\
		Programmatore & 2 & 32 \\
		Verificatore & 18 & 288\\
        \hline
        \textbf{Totale} & \textbf{53} & \textbf{1090}\\
		\hline
		\end{tabular}
