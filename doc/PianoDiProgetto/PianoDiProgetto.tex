...
%%%%%%%%%%%%%%FINE INTESTAZIONE COLONNE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		 \hline
%%%%%%%%%%% PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          0.5 & 05/12/2008 Inserimento Preventivo Rotazione Ruoli per fase di progetto & Cunico Marco \\         
...
%%%%%%%%%%% FINE PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{tabprevcaricopersonaore}
	\end{center}	
\end{table}

\sezione{Gestione del Piano di Progetto}
da completare\\
\subsezione{Obiettivi} PROBE si rende disponibile ad accogliere 
eventuali obiezioni che emergessero nel corso delle revisioni.
...
nella sezione "Assunzioni Iniziali". Data l'inesperienza dei membri della societ\`a \`e possibile che ci sia una 
discrepanza tra le ore preventivate e quelle presenti nel consuntivo.
