...
\renewcommand{\insertversion}{1.2} %INSERIRE LA VERSIONE QUI DENTRO STILE x.x.xx
...
%%%%%%%%%%%%%%FINE INTESTAZIONE COLONNE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			...
			Bizzotto Piero &  11   &  15 &  10   &   25  &  11   &  33  &  105 \\ % R4
			\hline
			Carollo Mirko &  12   &  15  &  10  &  25   &  9   &  34   &  105\\ % R5
			\hline
			Cunico Marco    &  11   &  20  &  23   &  24   &  20   &  7   &  105\\ % R2
			\hline
			Dal Bosco Davide        &  10   &  15   &  10   &  21   &   15  &  34  &  105\\ % R1
			\hline
			Dissegna Stefano        &  11  &  18   & 22  &  26   &  20  &  8  &  105\\ % R6
			\hline
			Geremia Mirco   &   14  &  10   &  18   &  13  &  15   &  35   &  105\\ % R7
			\hline		
%%%%%%%%%%% FINE PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\end{tabular}
