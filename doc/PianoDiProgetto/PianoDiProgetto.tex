...
\renewcommand{\insertversion}{2.1} %INSERIRE LA VERSIONE QUI DENTRO STILE x.x.xx
...
\begin{center}\textbf{Ore/Ruolo}
\end{center}
\includegraphics[width=300pt]{Cons-RPP-RQ2}
\newpage

\begin{center}\textbf{Costo/Ruolo}
\end{center}
\includegraphics[width=350pt]{Cons-RPP-RQ1}
...
%%%%%%%%%%%%%%FINE INTESTAZIONE COLONNE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			...
			\hline	
			Rizzo Maurizio  	&  8  &  16 &  0  &  0  &  22 &  0  &  46\\ %R3
			\hline	
%%%%%%%%%%% FINE PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\end{tabular}
