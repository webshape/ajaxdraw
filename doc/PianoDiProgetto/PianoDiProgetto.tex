...
\begin{table}[!h]
	\begin{center}
		\begin{tabular}
			...
			\hline
			%%%%%%%%%%% PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
			\multirow{2}{*}{Pre-RR} & Geremia Mirco \\
									&  \\
			\hline
			\multirow{2}{*}{RR-RPP} & \\
									& \\
...
La rotazione dei ruoli avviene come da tabella (\ref{tab:TabellaRotazRuoli}) a pagina ~\pageref{tab:TabellaRotazRuoli}.\\
...
All'interno di questa fase avverranno le due iterazioni previste. I requisiti non funzionali verranno soddisfatti in modo trasversale rispetto alle due iterazioni. La prima iterazione inizier\`a immediatamente dopo l'RPP e si concluder\`a a met\`a della fase RPP-RQ. Al termine dell'iterazione verranno soddisfatti i seguenti requisiti funzionali:
...
\item RFO-6
\item RFO-7
\item RFO-11 (parzialmente)
\item RFO-14 (parzialmente)
\item RFO-15 (parzialmente)
\end{elenconumerato} 

La seconda iterazione inizier\`a dopo la conclusione della prima. Al termine di questa iterazione il prodotto soddisfer\`a i seguenti requisiti funzionali:
...
\item RFO-9
\item RFO-10
\item RFO-11 (completamente)
\item RFO-12
\item RFO-13
\item RFO-14 (completamente)
\item RFO-15 (completamente)
\end{elenconumerato}

La seconda iterazione potr\`a inoltre soddisfare i seguenti requisiti funzionali in modo compatibile con le risorse disponibili:
