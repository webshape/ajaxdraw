...
WebShape, dopo un' attenta analisi, ha deciso di adottare per il progetto la licenza GPL. (Qui una persona a caso potrebbe aggiungere il perche' abbiamo scelto GPL)
