...
%%%%%%%%%%%%%%FINE INTESTAZIONE COLONNE%%%%%%%%%%%%%%
     \hline
%%%%%%%%%%% PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%
         1.1 & 21$\slash$01$\slash$2009 Aggiornamento in preparazione a RPP & Carollo Mirko        \\ 
      \hline
...
L'editor utilizzato per il codice JavaScript \`e \underline{emacs} con  \underline{js2-mode}, quest'ultimo permette di catturare la maggior parte degli errori di battitura e suggerisce la sintassi corretta mentre il codice viene digitato. 
 
\subsezione{Ricerca di errori}
Oltre alle utili funzionalit\`a di \underline{js2-mode}, l'azienda utilizza il programma \underline{JSLint}, un noto verificatore di codice Javascript, il quale rilevera' tutti gli altri errori.
...
L'azienda utilizza il software QUnit. \`E molto stabile e, avendo una buona copertura di unità,  \`e possibile eseguire i test di regressione dopo ogni piccolo passo, sempre. Ci\`o comporta un notevole risparmio di tempo.

\subsezione{Debug codice tramite browser}
Si utilizza Firebug, la famosa estensione di Firefox che consente di effettuare il debug di codice HTML e JavaScript direttamente dal browser.
\end{document}
