...
\renewcommand{\TITOLODOC}{Norme d.0i Progetto} %INSERIRE IL TITOLO DEL DOCUMENTO DA FAR COMPARIRE A PIE PAGINA
...
Oltre alle utili funzionalit\`a di js2-mode, l'azienda utilizza il programma \underline{JSLint}, un noto verificatore di codice JavaScript, il quale rilevera' tutti gli altri errori.
