...
\subsubsezione{UC8.2 Caso d'uso: disegna quadrato/rettangolo}
\paragraph{Attori coinvolti} Utente.
\paragraph{Scopo e descrizione sintetica} 
...
\subsubsezione{UC8.3 Caso d'uso: disegna poligono}
\paragraph{Attori coinvolti} Utente.
\paragraph{Scopo e descrizione sintetica} 
...
\subsubsezione{UC8.4 Caso d'uso: disegna casella di testo}
\paragraph{Attori coinvolti} Utente.
\paragraph{Scopo e descrizione sintetica} 
