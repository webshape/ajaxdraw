...
%%%%%%%%%%% PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
				\hline
				0.4 & 06$\slash$12$\slash$2008 Modifiche eseguite su segnalazione verificatore. & Bizzotto Piero \\
				\hline
...
\paragraph{Scopo e descrizione sintetica}
L'utente pu\`o cancellare totalmente quanto fino a quel momento ha disegnato.
\paragraph{Flusso di eventi}
\begin{elenconumerato}[\textbf{}]{\subsubsecindent}
...
\end{elenconumerato}
\paragraph{Precondizioni} La toolbar \`e visualizzata.
...
\subsubsezione{UC10.10 Caso d'uso: seleziona oggetto}
\paragraph{Attori coinvolti} Utente.
...
\item{AJAXDRAW permette di cambiare il colore di riempimento, del bordo, delle linee, dell'opacit\`a degli oggetti disegnati.}
...
\item{AJAXDRAW permette di cancellare completamente l'area di disegno.}
\end{elenconumerato}
...
\item Il prodotto dovr\`a essere implementato seguendo gli standard del \underline{linguaggio di markup} HTML 5.
