	...
	\begin{table}[!h]
		\begin{center}
			\begin{tabular}
				...
				\hline
				%%%%%%%%%%% PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%		
				{Pre-RR} & Piero Bizzotto \\ & Mirco Geremia\\
				\hline
				{RR-RPP} & \\
				\hline
...
%%%%%%%%%%%%%%FINE INTESTAZIONE COLONNE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		 \hline
%%%%%%%%%%% PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
    	 	0.1 &	 06$\slash$12$\slash$2008 Aggiunta termini da AnalisiDeiRequisiti & Piero Bizzotto \\
    	 	\hline
    	 	0.0 & 	 04$\slash$12$\slash$2008 Struttura e aggiunta termini da NormeDiProgetto & Mirco Geremia \\
