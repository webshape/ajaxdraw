...
\section*{J}
\textbf{JavaScript}
\text Linguaggio di programmazione client-side supportato dai principali browser.

\section*{S}
\textbf{SVG}
\text Formato di file per immagini vettoriali raccomandato dal \textit{W3C} basato su XML.
