...
%%%%%%%%%%%%%%FINE INTESTAZIONE COLONNE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     \hline
%%%%%%%%%%% PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     3.0 &    27$\slash$02$\slash$2009 Sistemazione in vista rilascio RQ & Carollo Mirko\\
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=4]{flussi.png}
\caption{flussi}
\end{figure} 
...
: realizzati tramite il software QUnit. Hanno l'obiettivo di considerare un piccola frazione del software per testare se tale porzione funziona come dovrebbe. 
\item \textit{Test di copertura}
: realizzati tramite il software JSCoverage. Verificano che i test di Unit\`a siano stati effettuati sull'intera porzione di software stabilita. Hanno l'obiettivo di verificare se sono state saltate righe di codice. Utile per garantire l'efficacia dei test di Unit\`a. 
