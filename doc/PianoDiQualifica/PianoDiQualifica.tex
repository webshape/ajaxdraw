...
\item Estendibilit\`a e mantenibilit\`a: il progetto dovr\`a prevedere la possibilt\`a che il prodotto possa essere facilmente esteso e mantenuto in futuro.
...
%%%%%%%%%%%%%%FINE INTESTAZIONE COLONNE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     ACO-1 & \\
     \hline
     ACO-2 & RFO-1 RFO-2 RFO-3 RFO-4\\ & RFO-5 RFO-6 RFO-7 RFO-8\\ & RFO-11 RF0-12 RFO-13 \\
     \hline
     ...
     \hline
     ACO-8 & RAO-4 RQO-3 RQO-4 RQO-5 RQO-6 \\
     \hline
     ACD-1 & RAO-5 \\
     \hline
     ACF-1 & \\
...
\end{table}
 ...
 \subsezione{Tracciamento Use Case - Requisiti}
\begin{table}[h]
\begin{center}
     \begin{tabular}
           {@{\extracolsep{\fill}}|c|c|}
...
%%%%%%%%%%% FINE PARTE DA MODIFICARE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \end{tabular}
  \caption{Use Case - Requisiti} %INSERIRE DIDASCALIA - SE NECESSARIA -
  \label{tab:aspettative}
  \end{center}
\end{table}
 \newpage
